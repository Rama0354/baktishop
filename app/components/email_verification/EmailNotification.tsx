"use client";
import { ResendEmailVerificationAction } from "@/app/lib/utils/action/AuthActions";
                    ...
                    <button
                      onClick={async () => {
                        await ResendEmailVerificationAction(session.user.email)
                          .then(() => {
                            toast.success(
                              "Email verifikasi telah dikirimkan ke alamat anda, silahkan cek dan lakukan ferifikasi!"
                            );
